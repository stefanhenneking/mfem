...
void Mesh::Print(adios2stream &out) const {
  ...
  if (NumOfElements == 0) {
    throw std::invalid_argument(
        "ERROR: number of elements is zero, in call to Print using "
        "adios2stream\n");
  }
  ...
  adios2::Variable<uint32_t> varNumOfVertices =
      io.DefineVariable<uint32_t>("NumOfVertices", {adios2::LocalValue});
  ...
  adios2::Variable<uint32_t> varNumOfElements =
      io.DefineVariable<uint32_t>("NumOfElements", {adios2::LocalValue});
